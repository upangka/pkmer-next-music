...
public interface FileMetadataInfoMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<FileMetadataInfo>, CommonUpdateMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, fileKey, fileMd5, fileName, fileMimeType, fileSuffix, fileSize, isPreview, isPrivate, bucket, bucketPath, uploadId, isFinished, isPart, partNumber, createTime, createUser, updateTime, updateUser);
